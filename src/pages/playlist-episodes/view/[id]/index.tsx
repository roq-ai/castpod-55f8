...
import { getPlaylistEpisodeById } from 'apiSdk/playlist-episodes';
...
function PlaylistEpisodeViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Playlist Episode Detail View
          </Text>
          {hasAccess('playlist_episode', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/playlist-episodes/edit/${data?.id}`} passHref legacyBehavior>
              <Button
