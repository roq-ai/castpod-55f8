...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Snippet', path: '/snippets', entity: 'snippet', service: AccessServiceEnum.PROJECT, icon: FiScissors },
